...
namespace Cloud7CMS.Controllers
{
    ...
    public class BkashController : Controller
    {
        ...
        public BkashController(ILogger<BkashController> logger)
        {
            _logger = logger;
        }
        ...
        public IActionResult BKDataViewer()
        {          
            
            return View();
        }

        public IActionResult BKDataEditor()
        {
        ...
        public dynamic GetCloud7BKServices()
        {
            BkashDataService dataService = new BkashDataService();
